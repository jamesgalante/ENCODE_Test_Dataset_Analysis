# Script: create_sceptre_diffex_input_Xie.R

### SETUP =====================================================================

# Saving image for debugging
save.image(paste0("RDA_objects/create_sceptre_diffex_input_Xie.rda"))
message("Saved Image")
...
cell_batches <- as.factor(sub("^(Batch\\d+)_.*", "\\1", cell_barcode))
