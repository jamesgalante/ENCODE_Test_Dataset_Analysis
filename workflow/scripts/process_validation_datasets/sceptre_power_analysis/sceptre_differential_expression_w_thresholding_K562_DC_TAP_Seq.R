# Script: sceptre_differential_expression_w_thresholding_K562_DC_TAP_Seq.R

### SETUP =====================================================================

# Saving image for debugging
if (!file.exists("RDA_objects/differential_expression_w_thresholding")) { dir.create("RDA_objects/differential_expression_w_thresholding", recursive = TRUE) }
save.image(paste0("RDA_objects/differential_expression_w_thresholding/", snakemake@wildcards$sample, ".rda"))
message("Saved Image")
