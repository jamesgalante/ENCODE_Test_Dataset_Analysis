...
save.image("RDA_objects/create_ep_benchmarking_dataset.rda")
...
# Temporarily remove one pair from Klann that gets mismapped -> move to earlier in pipeline during Klann processing
output <- output %>% filter(name != "BCYRN1|chr2:47336253-47337369:.")
